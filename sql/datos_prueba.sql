...
-- Alumno: Cesar Mendez | Fecha: 2026-06-01
-- =============================================================================
-- Orden de ejecucion: schema.sql -> alter_table.sql -> este script
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- Facturas (4) -- antes que servicio por FK nullable
-- FAC-0002 y FAC-0004: IVA 0% por transporte intracomunitario (art. 9.1.c LIVA)
-- -----------------------------------------------------------------------------
INSERT INTO factura
...
VALUES
    ...
    -- SRV-0008 (cancelado antes de ejecucion)
...
-- -----------------------------------------------------------------------------
-- Asignaciones (6) -- incluye reasignacion historica en SRV-0002
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Categorias por conductor (13 filas, PK compuesta)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Documentos de recurso (35)
-- Documentos vencidos: id=3,18,21,23,24,28,32 | Proximos: id=6,11
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Auditoria (18) -- se inserta al final; sin FK directas
-- -----------------------------------------------------------------------------
...
-- =============================================================================
-- Registros totales:
--   cliente:5 | vehiculo:6 | remolque:4 | conductor:6 | categoria_permiso:6
--   contacto:8 | direccion_operativa:8 | factura:4 | servicio:8
--   punto_servicio:17 | evento_seguimiento:24 | mercancia:10
--   requisito_especial:5 | incidencia:4 | asignacion:6 | coste_operativo:16
